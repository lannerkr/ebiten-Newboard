...
func cardimport() {
	...
	allCard[10] = Cardstr{"여 우", 2, nilcard, "____", nilcard, "꾀: 죽을 상황에 왼쪽\n의 칸이 비어 있으면\n그곳으로 도망친다", 2, 2, "wit"}
	...
	allCard[29] = Cardstr{"앵무새", 3, nilcard, "____", nilcard, "흉내: 해당 라인에 있\n는 모든 카드의 특정\n을 가진다", 2, 2, "copy"}

	allCard[30] = Cardstr{"붕 어", 0, nilcard, "____", nilcard, "물: 공격을 받으면 다\n음 자신의 턴에 1 회복\n한다", 2, 1, "water"}

	allCard[31] = Cardstr{"코뿔소", 3, nilcard, "____", nilcard, "돌진: 공격으로 상대\n를 죽이지 못한다면\n부가피해 1을 받는다", 4, 3, "rush"}

	allCard[32] = Cardstr{"사슴벌레", 3, nilcard, "____", nilcard, "자르기: 죽인 카드를\n잘라 3턴간 다신 판에\n올라오지 못하게한다", 3, 2, "incision"}
	...
	allCard[35] = Cardstr{"   양", 3, nilcard, "____", nilcard, "껌데기: 한번에 죽지\n않으면, 1번 공격을 무\n효화 한다", 3, 1, "shell"}
	...
	allCard[45] = Cardstr{"변형체", 3, nilcard, "____", nilcard, "변형: 상대의 방어특\n성을 무시합니다", 4, 3, "trans"}
	allCard[46] = Cardstr{"골 렘", 5, nilcard, "____", nilcard, "거대: 공격시, 오른쪽\n의 카드도 함께 공격", 9, 1, "huge"}
	allCard[47] = Cardstr{"물거미", 3, nilcard, "____", nilcard, "공기방탄: 상대 공격\n력에 상관없이, 2의 피\n해만 받는다", 3, 1, "airproof"}
...
func shuffleCard() {
	...
	//deckCard[0][1] = deckCardstr{allCard[10], theCardimg(allCard[10]), 0, 20, 1, false, false, nil}
